...
// Kontrak rasio default: 8:5 (1.6) mengikuti kartu katalog (320x200).
// Prop `aspectRatio` eksplisit menang; jika kosong, diturunkan dari width/height.
...
const OptimizedImage = ({
	...
	const handleImageError = (e) => {
		...
		if (
			...
			setImageSrc(
				appendParams(
					originalSrcRef.current.split("?")[0],
					`cb=${Date.now()}`,
				),
			);
			return;
	...
	// Rasio wrapper diserahkan ke CSS via custom property --image-aspect-ratio
